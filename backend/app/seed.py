...
def seed_if_empty(db: Session) -> None:
    ...
    samples = [
        (subnets[0], ".2", "allocated", "pc-hq-012", "AA:BB:CC:11:22:01", "行政办电脑", "pc", viewer, date.today() + timedelta(days=120)),
        (subnets[0], ".3", "allocated", "print-hq-01", "AA:BB:CC:11:22:15", "一楼打印机", "printer", netadmin, None),
        (subnets[0], ".4", "allocated", "ap-floor3", "AA:BB:CC:33:01:80", "3F-AP", "ap", netadmin, date.today() + timedelta(days=5)),
        (subnets[0], ".5", "disabled", None, None, None, None, None, None),
        (subnets[1], ".2", "allocated", "erp-app-01", "52:54:00:AB:01:10", "ERP 应用节点", "server", admin, None),
        (subnets[1], ".3", "allocated", "erp-db-01", "52:54:00:AB:01:11", "ERP 数据库", "server", admin, None),
        (subnets[1], ".4", "reserved", "vip-erp", None, None, None, admin, None),
        (subnets[2], ".2", "allocated", "dev-zhou-nb", "3C:22:FB:10:20:32", "周景行笔记本", "pc", biz, date.today() + timedelta(days=20)),
        (subnets[2], ".3", "allocated", "dev-build-02", "3C:22:FB:10:20:40", "编译机", "server", biz, None),
        (subnets[3], ".2", "allocated", "qa-web-01", None, "测试 Web", "server", netadmin, date.today() + timedelta(days=3)),
        (subnets[4], ".2", "allocated", "br-cam-01", "B0:BE:76:30:00:25", "前台摄像头", "camera", viewer, None),
    ]
